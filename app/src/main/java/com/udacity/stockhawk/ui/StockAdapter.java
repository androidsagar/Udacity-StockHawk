...
class StockAdapter extends RecyclerView.Adapter<StockAdapter.StockViewHolder> {
    ...
    class StockViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            bundle.putString(Contract.Quote.COLUMN_SYMBOL,cursor.getString(symbolColumn));
            bundle.putString(Contract.Quote.COLUMN_HISTORY,cursor.getString(historyColumn));
            bundle.putString(Contract.Quote.COLUMN_PRICE,cursor.getString(priceColumn));
            bundle.putString(Contract.Quote.COLUMN_NAME,cursor.getString(nameColumn));
